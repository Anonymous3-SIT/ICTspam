#!/usr/bin/env php
#Dilarang copyright coded Mr.TamfanX        2020 08 04 23:00
<?php
...
echo $R."\n::############[WELCOME:MY:HOME]##################";
echo $YY."\n::#:                                            #";
echo $BB."\n::#:Penutor  ::[Author:or:Mr.TamfanX]             #";
echo $RR."\n::#:Github   ::[http://github.com/Anonymous3-SIT:]  #";
echo $R."\n::#:Facebook ::[INVISIBLE CYBER TEAM:]           #";
echo $G."\n::#:YouTube  ::[Anonymous 37 :v:]                    #";
echo $GG."\n::#:Whatsapp ::[0899-9271-792]                 #";
echo $YY."\n::#:                                            #";
